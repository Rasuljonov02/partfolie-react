      ...
      <div className="flex p-3 pl-8 pr-8 w-[100%] bg-none items-center border-b-gray-900 justify-between">
        <div className="flex items-center gap-4">
          <span className="flex pl-4 items-center gap-1">
            <h1 className="rm text-[#ffffd5]">R... </h1>
        ...
        <span className="gap-4 flex items-center">
          <p
            className="a hover:-translate-y-1 hover:scale-110 hover:bg-[#4C4C4C] hover:text-yellow-200 cursor-pointer hover:rounded-2xl duration-300"
